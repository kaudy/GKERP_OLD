        ...
        <form class="form-horizontal" id="form-cad-fornecedor">
            ...
            <div>
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li role="presentation" class="active"><a href="#fornecedor-tab-geral" aria-controls="fornecedor-tab-geral" role="tab" data-toggle="tab">Geral</a></li>
                    <li role="presentation"><a href="#fornecedor-tab-endereco" aria-controls="fornecedor-tab-endereco" role="tab" data-toggle="tab">Endereço</a></li>
                    <li role="presentation"><a href="#fornecedor-tab-emails" aria-controls="fornecedor-tab-emails" role="tab" data-toggle="tab">E-mails</a></li>
                    <li role="presentation"><a href="#fornecedor-tab-telefones" aria-controls="fornecedor-tab-telefones" role="tab" data-toggle="tab">Telefones</a></li>                    
                </ul>
                ...
                <div class="tab-content">
                    ...
                    <div role="tabpanel" class="tab-pane" id="fornecedor-tab-emails">E-mails</div>
                    <div role="tabpanel" class="tab-pane" id="fornecedor-tab-telefones">Telefones</div>
